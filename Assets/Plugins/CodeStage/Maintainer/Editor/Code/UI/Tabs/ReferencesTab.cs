...
namespace CodeStage.Maintainer.UI
{
	...
	internal class ReferencesTab
	{
		...
		public void Refresh(bool newData)
		{
			if (newData)
			{
				MaintainerPersonalSettings.References.treeViewState = new TreeViewState();
				treeModel = null;
			}

			if (treeModel == null)
			{
				var firstInit = MaintainerPersonalSettings.References.multiColumnHeaderState == null || MaintainerPersonalSettings.References.multiColumnHeaderState.columns == null || MaintainerPersonalSettings.References.multiColumnHeaderState.columns.Length == 0;
				var headerState = ReferencesTreeView<ReferencesTreeElement>.CreateDefaultMultiColumnHeaderState();
				if (MultiColumnHeaderState.CanOverwriteSerializedFields(MaintainerPersonalSettings.References.multiColumnHeaderState, headerState))
					MultiColumnHeaderState.OverwriteSerializedFields(MaintainerPersonalSettings.References.multiColumnHeaderState, headerState);
				MaintainerPersonalSettings.References.multiColumnHeaderState = headerState;
				...
				treeView = new ReferencesTreeView<ReferencesTreeElement>(MaintainerPersonalSettings.References.treeViewState, multiColumnHeader, treeModel);
