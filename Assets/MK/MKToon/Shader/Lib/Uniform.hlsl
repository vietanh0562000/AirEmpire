...
//////////////////////////////////////////////////////
	...
	CBUFFER_END
		...
		void SetupDOTSLitMaterialPropertyCaches()
		{
			...
			mk_DOTS_Cached_RefractionDistortion = MK_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _WrappedLighting);
			mk_DOTS_Cached_RefractionDistortion = MK_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _FresnelHighlights);
			mk_DOTS_Cached_RefractionDistortion = MK_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _DetailBlend);
			mk_DOTS_Cached_RefractionDistortion = MK_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _VertexAnimationStutter);
		...
		#define _RefractionDistortion MK_SET_DOTS_INSTANCED_PROP(float, _WrappedLighting)
		#define _RefractionDistortion MK_SET_DOTS_INSTANCED_PROP(float, _FresnelHighlights)
		#define _RefractionDistortion MK_SET_DOTS_INSTANCED_PROP(float, _DetailBlend)
		#define _RefractionDistortion MK_SET_DOTS_INSTANCED_PROP(float, _VertexAnimationStutter)
	#endif
